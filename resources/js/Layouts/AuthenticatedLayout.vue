...
// confirmDialogStore.$subscribe((mutation, state) => {
//     if (state.isConfirmed === true && state.target === confirmTarget) {
//         confirmed()
//     }
// })
...
// watchEffect(
//     () => {
//         if (isValidConfirmation(confirmTarget)) {
//             confirmed()
//         }
//     }
// )
                        ...
                        <div class="relative ms-3">
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <!-- <DropdownLink data-modal-target="confirm-dialog-modal"
                                    ...
                                    <a :href="route('logout')"
                                        ...
                                        data-drawer-target="confirm-dialog-drawer"
                                        data-drawer-toggle="confirm-dialog-drawer" data-drawer-placement="right"
                                        v-on:click.prevent="setConfirmDialog()"> Log Out </a>
                                </template>
                            </Dropdown>
                        </div>
                    </div>
