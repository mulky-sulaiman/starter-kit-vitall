...
<template>
    ...
    <header id="main_header" class="md:sticky md:top-0 md:z-40">
                    ...
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="#"
                                ...
                                aria-current="page">{{ $t('header.home') }}</a>
                            ...
                            <div id="mega-menu"
                                ...
                                <div class="px-5 py-5 bg-gray-50 lg:rounded-lg lg:col-span-1 dark:bg-gray-700">
                                    ...
                                    <ul class="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                                        ...
                                        <li>
                                            <a href="#" class="hover:text-primary-600 dark:hover:text-primary-500">Web
                                                Design</a>
                                        </li>
                                    </ul>
                                </div>
        ...
        <!-- Secondary Nav -->
        <div v-if="$slots.second_navbar">
            <slot name="second_navbar" />
        </div>
    </header>
        ...
        <div class="max-w-screen-xl p-4 py-6 mx-auto md:p-8 lg:-10">
            <div class="grid grid-cols-2 gap-8 lg:grid-cols-6">
                <div class="col-span-2">
                    ...
                    <ApplicationLogo class="h-8 mr-2" fill="currentColor" />
                    {{ $t('index.brand') }}
                    </Link>
                    <p class="my-4 font-light text-gray-500 dark:text-gray-400">VITALL is a Starter Kit made from
                        the
                        technology stack of <span class="font-semibold">V</span>ueJS, <span
                            class="font-semibold">I</span>nertiaJS, <span class="font-semibold">T</span>ailwindCSS,
                        <span class="font-semibold">A</span>lpineJS,
                        <span class="font-semibold">L</span>ivewire, and <span class="font-semibold">L</span>aravel.
            ...
            <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024 <a href="#"
                    class="hover:underline">VITALL ™</a>. All Rights Reserved.</span>
        </div>
    </footer>
    <!-- </DefaultLayout> -->
    <!-- <Toast :type="props.type" :message="props.message" /> -->
</template>
