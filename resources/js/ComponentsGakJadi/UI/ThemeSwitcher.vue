...
<template>
    ...
    <button @click="toggleDarkMode()" id="theme-toggle" data-tooltip-target="tooltip-theme-toggle"
    ...
    <div id="tooltip-theme-toggle" role="tooltip"
        ...
        <span v-text="colorMode.preference == 'light' ? 'Enter Dark Mode' : 'Enter Light Mode'"></span>
